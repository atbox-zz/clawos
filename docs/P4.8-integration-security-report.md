...
// Command: lsmod | grep -E 'bpf|seccomp|cgroup|tpm'
// Expected: All modules loaded
// Failure: BLOCK - Abort startup

// A-03: Security Features Enabled
// Features: KASLR, SMEP, SMAP, PTI
// Command: cat /proc/cmdline | grep -E 'kaslr|smep|smap|pti'
...
// Command: lscpu | grep -E 'sgx|smep|smap|nx'
...
// E-02: Disk Space
// Command: df -h /clawfs | tail -1 | awk '{print $4}'
// Expected: >= 10 GB free
